...
const addNote = async () => {
  ...
  await fetch("https://agenda-qvpp.onrender.com:10000/notes", {
    method: "post",
...
const deleteTask = async (id) => {
  await fetch(`https://agenda-qvpp.onrender.com:10000/notes/${id}`, { method: "delete" });

  loadNotes();
};

const updateNote = async ({ id, descricao, valor }) => {
  await fetch(`https://agenda-qvpp.onrender.com:10000/notes/${id}`, {
    method: "put",
    headers: { "Content-Type": "application/json" },
