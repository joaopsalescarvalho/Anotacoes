...
const fetchNotes = async () => {
  const res = await fetch("https://agenda-qvpp.onrender.com/notes");
...
const addNote = async () => {
  ...
  await fetch("https://agenda-qvpp.onrender.com/notes", {
    method: "post",
...
const deleteTask = async (id) => {
  await fetch(`https://agenda-qvpp.onrender.com/notes/${id}`, { method: "delete" });

  loadNotes();
};

const updateNote = async ({ id, descricao, valor }) => {
  await fetch(`https://agenda-qvpp.onrender.com/notes/${id}`, {
    method: "put",
    headers: { "Content-Type": "application/json" },
